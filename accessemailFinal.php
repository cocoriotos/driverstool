...
//$username = $conn->real_escape_string("$name $lastname");
//$email1 = $conn->real_escape_string($email);
...
//$query1 = "INSERT INTO drivers_accesslist(username, email, active, visits, role, country, city, password) VALUES ('$username', '$email', 1, 1, 'user', '$country', '$city', '$password')";
