...
<html lang="us"> <!-- Page language-->
	...
	<header>
	  ...
	  <body>
		...
		<footer id="contact">
				<hgroup>
					<h4 align="center"><address><strong>Web Admin:</strong> Julian Gonzalez Bucheli</address></h4>
					<h4 align="center"><address><strong>Email:</strong>cocoriotos@hotmail.com</address></h4>
					<h4 align="center"><address><strong>Phone:</strong>(+57) 305 429 31 85 </address></h4>
					<h4 align="center"><address><strong>Pereira - Colombia </strong></address></h4>
					<h4 time align="center" datetime="2021/4/1" pubdate>Published on Date: 01/04/2021 - WEB Page available: Monday to Friday  8 a.m. to 5 p.m.</time></h4> <!-- Publication format layout-->
				</hgroup>
		</footer>
	</body>
</html>