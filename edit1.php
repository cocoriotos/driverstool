...
<div class="container p-4">
			...
			<center>
				...
				<form action="updatevalues.php" method="POST"> 
					...
					<input type="text" style="color:black; font-size: 150%; text-align: center;" name="hoursbyday" class="form-control" placeholder="hoursbyday" autofocus value="<?php echo $row['hoursbyday']; ?>" ></input>
					<input type="text" class="form-control" style="color:black; font-size: 150%; text-align: center;" name="description" placeholder="Descripción corta del Servicio" autofocus required /><br>
					<br>
                    ...
                    <input type="submit" style="font-size: 150%; text-align: center;" class="btn btn-success btn-block" name="cancel" value="Cancel" formaction="driversQuotationOpsaAndAdminVehicle.php"/>				</form>
			</center>					
