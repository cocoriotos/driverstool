...
<div class="container p-4">
			...
			<center>
				...
				<form action="quotation.php" method="POST"> 
					...
					<center><input type="text" class="form-control" style="color:black; font-size: 150%; text-align: center;" name="description" placeholder="Descripción corta del Servicio" autofocus required /></center><br>
					<br>
